...
/**
  ...
  * @brief          : Folyade'k krista'lyos LCD I2C-vel csatlakoza'sa'hoz szu:kse'ges ko:nyvta'r
	* -------------
	* [Source in internet](https://github.com/eziya/STM32_HAL_I2C_HD44780/blob/master/Src/liquidcrystal_i2c.h)
  ******************************************************************************
  */
...
/** Commands in LDC instruction Register
	* ------------------------------------*/
...
/** Register Select Bit if 0: sent data(byte) is a _command_ for cmd register, else: _1_ that is a __data__ for data register*/
#define RS 0x01

/** Device I2C Address for PCF8574AT */
